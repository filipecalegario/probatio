...
public class SensorNames {
	...
	static{
		...
		names.put(20, "Botao do Encoder 1");
		names.put(21, "Botao do Encoder 2");
		names.put(22, "Encoder 1");
		names.put(23, "Encoder 2");
	}
