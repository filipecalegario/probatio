...
public class SculptureMapper extends PApplet{
	...
	private void createInputController(String name, final int ccNumber, final int channel, final int minimum, final int maximum) {
		Mapper.Device.Signal inp1 = dev.addInput(name, 1, 'f', "u",
				//new PropertyValue('f', 0.0),
				//new PropertyValue('f', 127.0),
				new PropertyValue('f', minimum),
				new PropertyValue('f', maximum),
				new InputListener() {
			public void onInput(Mapper.Device.Signal sig,
				...
				//sendCC(v[0]);
				ControlChange change = new ControlChange(channel-1, ccNumber, (int)v[0]);
	...
	public static  void main(String[] passedArgs) {
		...
		String[] appletArgs = new String[] {"main.SculptureMapper"};
		if (passedArgs != null) {
