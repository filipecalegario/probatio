...
class test {
	public static void main(String [] args) {
		...
		Mapper.Device.Signal inp1 = dev.add_input("insig1", 1, 'f', "Hz", 2.0, null, new InputListener() {
		...
		Signal out1 = dev.add_output("outsig1", 1, 'i', "Hz", 0.0, 100.0);
		...
		System.out.println(inp1.name() + " allocation mode: " + inp1.instance_allocation_mode());
...
//		out2.release_instance(20);
		...
		System.out.println(inp1.name() + " instance 10 cb is " + inp1.get_instance_callback(10));
		...
		System.out.println();
		System.out.println("Number of connections from " + out1.name() + ": " + out1.num_connections());
