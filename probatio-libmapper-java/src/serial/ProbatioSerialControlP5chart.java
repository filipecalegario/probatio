...
public class ProbatioSerialControlP5chart extends PApplet implements BlockParserObserver{
	...
	ProbatioParserWithBlockController parser;
	...
	public void setup() {
		...
		parser = new ProbatioParserWithBlockController(this);
		parser.attach(this);
		
		MapperManagerProbatio mapper = new MapperManagerProbatio();
...
//			float y = (ySize * linha) + ((linha + 1)*20);
	...
	static public void main(String[] passedArgs) {
		String[] appletArgs = new String[] { "serial.ProbatioSerialControlP5chart" };
		if (passedArgs != null) {
